...
export const ChatImage = () => {
  return (
    <Image xmlns="http://www.w3.org/2000/svg" width="241" height="242" viewBox="0 0 241 242" fill="none">
...
export const TeamImage = () => {
  return (
    <Image xmlns="http://www.w3.org/2000/svg" width="233" height="240" viewBox="0 0 233 240" fill="none">
